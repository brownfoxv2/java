...
<div class="jumbotron text-center">
  <div class="container">
    ...
    <p>This is a sample Java application deployed to Heroku version 1.0. It's a reasonably simple app - but a good foundation for understanding how to get the most out of the Heroku platform.</p>
